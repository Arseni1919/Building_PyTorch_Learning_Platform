...
from topics.basic.topic_03_neural_networks import get_topic_content, QUESTIONS
...
with col1:
    st.info("⬅️ Previous: **02 - Autograd & Backpropagation**")
with col2:
    st.info("➡️ Next: **04 - Loss Functions & Optimizers** (Coming Soon)")

...
from topics.basic.topic_06_evaluation import get_topic_content, QUESTIONS
...
st.success("🎉 **Congratulations!** You've completed the Basic Level!")
st.markdown("---")

col1, col2 = st.columns(2)
with col1:
    st.info("⬅️ Previous: **05 - Training Your First Model**")
with col2:
    st.info("➡️ Next: **07 - Custom Datasets & DataLoaders** (Intermediate Level - Coming Soon)")

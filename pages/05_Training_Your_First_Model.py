...
from topics.basic.topic_05_training import get_topic_content, QUESTIONS
...
with col1:
    st.info("⬅️ Previous: **04 - Loss Functions & Optimizers**")
with col2:
    st.info("➡️ Next: **06 - Evaluation & Metrics** (Coming Soon)")

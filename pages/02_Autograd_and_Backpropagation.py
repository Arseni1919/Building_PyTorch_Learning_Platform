...
from topics.basic.topic_02_autograd import get_topic_content, QUESTIONS
...
with col1:
    st.info("⬅️ Previous: **01 - PyTorch & Tensors**")
with col2:
    st.info("➡️ Next: **03 - Building Neural Networks** (Coming Soon)")
